...
type
  ...
  TPopupMenuThread = class(TCustomThread)
  strict private
...
procedure TPopupMenuThread.SetToDoCommand(const AToDoCommand: TToDoCommand);
begin
...
function TPopupMenuThread.GetToDoCommand: TToDoCommand;
begin
  FFieldAccessCriticalSection.Enter;
  try
    Result := FToDoCommand;
