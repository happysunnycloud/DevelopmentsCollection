{TODO: Постепенно выводим из эксплуатации}
{0.8}
...
type
  ...
  public
    ...
    class procedure CheckHasComponentProperty(const AComponent: TComponent; const APropertyName: String); deprecated 'Use FMX.ControlToolsUnit';

    //устанавливает значение свойства Text у компонента
    class procedure SetComponentText(const AComponent: TComponent; const AText: String); deprecated 'Use FMX.ControlToolsUnit';
    //читает значение свойства Text у компонента
    class function  GetComponentText(const AComponent: TComponent): String; deprecated 'Use FMX.ControlToolsUnit';

    //устанавливает значение свойства Text у компонента
    class procedure SetTextProperty(const AComponent: TComponent; const AText: String); deprecated 'Use FMX.ControlToolsUnit';
    //читает значение свойства Text у компонента
    class function  GetTextProperty(const AComponent: TComponent): String; deprecated 'Use FMX.ControlToolsUnit';
