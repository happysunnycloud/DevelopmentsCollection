//нужно переводить с suspended на TEvent
{1.10}
//инициализирует только один объект для обработки сообщений
...
{
//пример процеруды –есивера при приеме сообщений
//на нее должна ссылатьс€ TranslateMessage(AMessageId:LongWord; AReceiver: TReceiver; AParameters: Array of Const);
