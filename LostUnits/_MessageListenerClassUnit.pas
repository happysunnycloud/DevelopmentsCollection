{1.1}//перевел на TEvent вместо suspended
...
type
  ...
  TMessageListener = class
  private
    fAccessToQueue: TCriticalSection;
    fMessageListenerThread: TMessageListenerThread;
    fStopListening: Boolean;
    function GetAccessToQueue: TCriticalSection;
    property AccessToQueue: TCriticalSection read GetAccessToQueue;
  public
...
begin
  while fMessageListenerThread.MessageStack.Count > 0 do
  begin
...
function TMessageListener.GetAccessToQueue: TCriticalSection;
begin
