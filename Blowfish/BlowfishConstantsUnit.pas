...
const
  CRYPT_KEY = '36738DBE308E404A6E25C0203B24C5BDE70F3FB22196280435FEFDE5CF99F546';

  N = 16;

  ORIG_P: array [0..17] of UInt = (
  ...
  ORIG_S: array [0..3, 0..255] of UInt = (
...
type
  TBLOWFISH_CTX = record
    P: array [0..17] of UInt;
    S: array [0..3, 0..255] of UInt;
  end;
